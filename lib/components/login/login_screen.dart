...
class LoginScreenForEmailAndSocial extends StatelessWidget {
  ...
  LoginScreenForEmailAndSocial({Key? key, required this.controller})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
                    ...
                    child: Column(
                        ...
                        children: [
                          ...
                          ThemeInput(
                            ...
                            theValidation: controller.validateUsername,
                          ...
                          Center(
                            child: ThemeButton(
                                ...
                                theAction: controller.goToPasswordScreen,
                                theLoadingStatus: false),
                          ),
                          SizedBox(height: 5.0.hp),
                          Center(
...
class LoginScreenForPassword extends StatelessWidget {
  LoginController controller;
  LoginScreenForPassword({Key? key, required this.controller})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Scaffold(
