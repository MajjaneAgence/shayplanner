  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomSheet: Container(
        width: 100.0.wp,
        height: 62.0.hp,
        padding: EdgeInsets.only(top: 4.0.hp, left: 10.0.wp),
        decoration: BoxDecoration(
          color: white,
            ...
            children: [
              InkWell(
                ...
                children: [
                  ...
                  SizedBox(width: 10.0.wp),
                  SvgPicture.asset("assets/icons/profile/arrow_right.svg",
                      width: 10.0.sp, height: 10.0.sp),
                ],
              ),),
              SizedBox(height: 3.0.hp),
                            InkWell(
