final Map<String, String> fr = {
  ...
  "tr_enter_email_to_receive_code":
      "Veuillez saisir votre email pour recevoir le code permettant de réinitialiser le mot de passe",
  ...
  //Register
  "tr_create_account_by_filling_inputs":
      "Créer votre compte en renseignant les champs ci-dessous :",
  "tr_firstname": "Prénom",
  'tr_lastname': "Nom",
  "tr_confirm_password":
